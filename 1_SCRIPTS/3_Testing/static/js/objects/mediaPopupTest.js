...
document.addEventListener('DOMContentLoaded', async (event) => {
  ...
  *********************************************************************/
  ...
  function handleMPClick(event) {
    const mp_id = event.detail.id;
    const mp_type = event.detail.mediaplayer_type;
    const mp_title = event.detail.mediaplayer_title;
    ...
    updatePopupHeader(header_content);
    updatPopupBody(mp_body, edit_mode);
    showPopup();
  }


  function toggleEditMode(event) {
    edit_mode = event.detail.edit_mode;
  }


  function updatePopupHeader(content) {
    ...
    document.querySelector('.popup-description').textContent = content.description;
  }


  function updatPopupBody() {
      clearBody();
      setContent();
