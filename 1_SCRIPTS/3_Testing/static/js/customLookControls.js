 ...
 */
registerComponent('custom-look-controls', {
  ...
  */
  ...
  updateOrientation: function () {
   ...
   // console.log("x ", this.magicWindowDeltaEuler.x );
    object3D.rotation.x = this.magicWindowDeltaEuler.x + pitchObject.rotation.x;
    object3D.rotation.y = this.magicWindowDeltaEuler.y + yawObject.rotation.y;

    //console.log("z ",object3D.rotation.z = this.magicWindowDeltaEuler.z);
  ...
  onTouchMove: function (evt) {
    ...
    yawObject.rotation.y -= deltaY * touchSensitivity * direction; //Y
    pitchObject.rotation.x -= deltaX * touchSensitivity * direction; //X
    pitchObject.rotation.x = Math.max(-Math.PI / 2, Math.min(Math.PI / 2, pitchObject.rotation.x)); //  x between -90 to 90 degrees
